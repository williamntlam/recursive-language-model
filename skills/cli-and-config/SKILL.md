...
adding a configuration key or changing a command. Inspect
`tests/integration/test_cli.py` or `tests/unit/test_config.py` as applicable,
then load `../testing/SKILL.md`.
